...
Ответ должен быть мистическим и глубоким, но избегай технических деталей расчётов. Соедини все элементы — возраст, знак зодиака, лунный день и число судьбы — в единое предсказание. Тон ответа должен быть пророческим и вдохновляющим, с акцентом на духовные и личностные аспекты.";
        ...
        {
            var zodiak = Zodiak(date);
            var text = $@"Ты эксперт в астрологии и отношениях. Проведи анализ совместимости знака зодиака {zodiak} с каждым из 12 знаков зодиака. Для каждого знака подробно опиши эмоциональную, интеллектуальную и физическую совместимость с {zodiak}. Укажи сильные и слабые стороны отношений, возможные конфликты и их разрешение.
Для каждого знака объясни, какие аспекты их личности могут притягивать к {zodiak}, а какие могут создавать трудности. Укажи, как каждый знак может развивать отношения с {zodiak} и улучшать взаимопонимание. Ответ должен быть конкретным, глубоким и вдохновляющим, с акцентом на возможности роста и гармонии в отношениях.";
